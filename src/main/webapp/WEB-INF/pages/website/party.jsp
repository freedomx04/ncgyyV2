			...
			<div class="ibox-content">
				<div class="tabs-container">
					<ul class="nav nav-tabs">
						<li class="active">
							<a data-toggle="tab" href="#party-dynamic" data-tab="dynamic" aria-expanded="true">党建信息</a>
						</li>
						<li>
							<a data-toggle="tab" href="#party-policy" data-tab="policy" aria-expanded="false">党政法规</a>
						</li>
					</ul>
					<div class="tab-content">
						<div id="party-dynamic" class="tab-pane active">
						...
						<div id="party-policy" class="tab-pane">
							<div class="panel-body">
